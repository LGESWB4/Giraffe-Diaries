...
class HomeScreen extends GetView<CalendarController> {
  ...
  // 공통 스타일 정의
  static const EdgeInsets datePadding =
                    ...
                    children: [
                      TableCalendar(
                        ...
                        calendarStyle: CalendarStyle(
                          ...
                          holidayTextStyle:
                              const TextStyle(color: customOrange),
...
class MonthPickerSheet extends StatefulWidget {
  const MonthPickerSheet({Key? key}) : super(key: key);
          ...
          Row(
            ...
            children: [
              IconButton(
                ...
                onPressed: currentDate.year <= firstYear
                    ? null
                    : () => changeYear(false),
              ...
              IconButton(
                ...
                onPressed: currentDate.year >= lastYear
                    ? null
                    : () => changeYear(true),
